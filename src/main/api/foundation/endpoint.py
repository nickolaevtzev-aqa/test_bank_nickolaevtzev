...
from src.main.api.models.credit_requesting_response import CreditRequestingResponse
...
class Endpoint(Enum):
	...
	CREDIT_REQUEST = EndpointConfiguration(
			request_model=CreditRequestingRequest,
			url="/credit/request",
			response_model=CreditRequestingResponse
	)
